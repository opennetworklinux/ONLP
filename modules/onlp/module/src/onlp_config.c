...
#endif
#ifdef ONLP_CONFIG_DYNAMIC_PLATFORM_LOADING
    { __onlp_config_STRINGIFY_NAME(ONLP_CONFIG_DYNAMIC_PLATFORM_LOADING), __onlp_config_STRINGIFY_VALUE(ONLP_CONFIG_DYNAMIC_PLATFORM_LOADING) },
#else
{ ONLP_CONFIG_DYNAMIC_PLATFORM_LOADING(__onlp_config_STRINGIFY_NAME), "__undefined__" },
#endif
